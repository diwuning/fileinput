...
import com.h.fileinput.Glin.ViewHelper;
...
public class EmptyView extends FrameLayout implements View.OnClickListener {
    ...
    // 数据为空，网络失败， 加载中 无网络连接
    private String[] mNoticeString = new String[]{"暂无数据", "暂无网络连接", "", ""};
...
//        }
    ...
    public View getmErrorNetLayout() {
        return mErrorNetLayout;
    }

    public void setmErrorNetLayout(View mErrorNetLayout) {
        this.mErrorNetLayout = mErrorNetLayout;
    }
}
