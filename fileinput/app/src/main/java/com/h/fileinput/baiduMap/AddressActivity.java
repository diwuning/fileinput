package com.h.fileinput.baiduMap;
...
//        bdLocation = new BDLocation();
        mLocationClient1.registerLocationListener(myListener1);
...
//        Logger.t(TAG).d("1111111111111111");
...
//            AddAddrActivity.this.bdLocation = location;
            Log.d(TAG, location.getCity());
//            Logger.t(TAG).d("22222222222222"+location.getCity());

            //Receive Location
            tv_addr.setText(location.getCity()+" "+location.getAddrStr());
            ...
            Log.i("BaiduLocationApiDemo", "AddAddrActivity="+sb.toString());
